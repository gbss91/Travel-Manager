...
class FlightsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create flight" do
    ...
    post booking_flights_path(@booking),
         params: { flight: { booking_id: @booking.id, adults: @flight.adults, arrival_time: @flight.arrival_time,
                             carrier: @flight.carrier, departure_time: @flight.departure_time,
                             ...
                             total_price: @flight.total_price, carrier_code: @flight.carrier_code,
